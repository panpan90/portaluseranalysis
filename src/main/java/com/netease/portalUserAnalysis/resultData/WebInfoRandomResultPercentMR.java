...
public class WebInfoRandomResultPercentMR extends MRJob {

	@Override
	public boolean init(String date) {
        	inputList.add(DirConstant.USER_PROFILE_BASE_DIR + "webInfoResultPercent/" + date);
		    outputList.add(DirConstant.USER_PROFILE_BASE_DIR + "webInfoRandomResultPercent/" + date);
		return true;
	}
	...
	public static class webStatisticInfoPercentMapper extends Mapper<Text, Text, Text, Text> {
		...
		public void map(Text key, Text value, Context context) throws IOException, InterruptedException {
               ...
               if(r.nextInt(20)<2 && sex.equals("male")){
