...
public class WeeklywebInfoRandomResultMR extends MRJob {

	@Override
	public boolean init(String date) {
        	inputList.add(DirConstant.USER_PROFILE_BASE_DIR + "weeklyWebInfoResult/" + date);
		    outputList.add(DirConstant.USER_PROFILE_BASE_DIR + "weeklyWebInfoRandomResult/" + date);
		return true;
	}
