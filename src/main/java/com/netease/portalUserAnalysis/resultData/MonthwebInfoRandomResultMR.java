...
public class MonthwebInfoRandomResultMR extends MRJob {

	@Override
	public boolean init(String date) {
        	inputList.add(DirConstant.USER_PROFILE_BASE_DIR + "monthWebInfoResult/" + date);
		    outputList.add(DirConstant.USER_PROFILE_BASE_DIR + "monthWebInfoRandomResult/" + date);
		return true;
	}
