package com.netease.portalUserAnalysis.statistics.userProfile.web;
...
public class ActionPerUserWebMR extends MRJob {

	@Override
	public boolean init(String date) {
	   inputList.add(DirConstant.WEBLOG_FilterLOG + date);
	   outputList.add(DirConstant.USER_PROFILE_TEMP_DIR +"actionPerUserWeb/"+ date);
	   return true;
	}
	...
	public int run(String[] args) throws Exception {
		int jobState = JobConstant.SUCCESSFUL;
        	...
        	Job job = HadoopUtils.getJob(this.getClass(), this.getClass()
       		...
       		// combiner
//       		job.setCombinerClass(PvShareBackReducer.class);
	  ...
	  public static class LogMapper extends Mapper<NullWritable, Text, Text, StatisticResultWrapWritable> {
	        ...
	        public void map(NullWritable key, Text value, Context context) throws IOException, InterruptedException {
	        	try {
					...
					if (!sid.equals("(null)")&&!StringUtils.isBlank(sid)){
						...
						srww.getStatistic().put("sid_time"+sid+"#Time#"+serverTime, 1);
					}
