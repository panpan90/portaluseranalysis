...
public class CombineWebStatisticInfoMR extends MRJob {

	@Override
	public boolean init(String date) {
		inputList.add(DirConstant.USER_PROFILE_TEMP_DIR + "genTiePerUser/" + date);
		inputList.add(DirConstant.USER_PROFILE_TEMP_DIR +"actionPerUserWeb/"+ date);
		outputList.add(DirConstant.USER_PROFILE_BASE_DIR + "combineWebStatisticInfo/" + date);
		return true;
	}
